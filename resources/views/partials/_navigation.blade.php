          ...
          <a href="{{ route('home') }}">
            <svg class="h-20 md:h-[90px]  w-auto" xmlns="http://www.w3.org/2000/svg"
              ...
              <g>
                <g>
                  <g>
                    <path class="fill-primary" d="M173.5,104.3c30.4-17.9,66-28,103.9-27.7c63.9,0.6,120.8,31.4,157.3,78.6h47.9
                    ...
                    C171.6,104.2,172.7,104.8,173.5,104.3z" />
                              ...
                              <g>
                                <path class="fill-primary" d="M392.4,441.7c-16.2,11.6-34,20.8-52.9,27.2c-19.4,6.6-39.8,10.1-60.3,10.5c-18.3,0.4-36.7-1.8-54.5-6.4
                    ...
                    C422.7,416.4,408.4,430.2,392.4,441.7z" />
                              ...
                              <g>
                                <path class="fill-primary" d="M246.1,437.5c1.3,0.2,2.7,0.5,4,0.7c0,0,0,0,0,0c3.8,0.6,7.7,1,11.6,1.4c0.9,0.1,1.9,0.1,2.8,0.2
